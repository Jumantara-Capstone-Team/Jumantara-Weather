    ...
    /*! jQuery v3.6.0 | (c) OpenJS Foundation and other contributors | jquery.org/license */ ! function(e, t) {
                    ...
                    return r != C && 9 === r.nodeType && r.documentElement && (a = (C = r).documentElement,
                        E = !i(C), p != C && (n = C.defaultView) && n.top !== n && (n.addEventListener ? n
                            ...
                            a.appendChild(e).innerHTML = "<a id='" + S + "'></a><select id='" + S +
                                ...
                                .querySelectorAll("[id~=" + S + "-]").length || v.push("~="), (t = C
                                    .createElement("input")).setAttribute("name", ""), e
                                .appendChild(t), e.querySelectorAll("[name='']").length || v.push(
                                    "\\[" + M + "*name" + M + "*=" + M + "*(?:''|\"\")"), e
                                .querySelectorAll(":checked").length || v.push(":checked"), e
                                .querySelectorAll("a#" + S + "+*").length || v.push(".#.+[+~]"), e
                        ...
                        function(e, t) {
                            ...
                            return n || (1 & (n = (e.ownerDocument || e) == (t.ownerDocument || t) ? e
                                ...
                                .compareDocumentPosition(e) === n ? e == C || e.ownerDocument == p && y(
                                    p, e) ? -1 : t == C || t.ownerDocument == p && y(p, t) ? 1 : u ? P(
                                    u, e) - P(u, t) : 0 : 4 & n ? -1 : 1)
                        } : function(e, t) {
                            if (e === t) return l = !0, 0;
                            var n, r = 0,
            ...
            return me.prototype = b.filters = b.pseudos, b.setFilters = new me, h = se.tokenize = function(e,
                t) {
                    ...
                    if (!a) {
                        ...
                        (a = A(e, (v = o, m = 0 < (y = i).length, x = 0 < v.length, r = function(e, t, n, r,
                        i) {
                            var o, a, s, u = 0,
                                l = "0",
                                c = e && [],
            ...
            add: function(t, e, n, r, i) {
                ...
                if (V(t)) {
                    n.handler && (n = (o = n).handler, i = o.selector), i && S.find.matchesSelector(re, i),
                        n.guid || (n.guid = S.guid++), (u = v.events) || (u = v.events = Object.create(
        ...
        S.extend({
            ...
            clone: function(e, t, n) {
                ...
                if (t)
                    if (n)
                        for (o = o || ve(e), a = a || ve(c), r = 0, i = o.length; r < i; r++) Le(o[r],
                            a[r]);
                    else Le(e, c);
        ...
        function We(e, t, n) {
            ...
            return (n = n || Re(e)) && ("" !== (a = n.getPropertyValue(t) || n[t]) || ie(e) || (a = S.style(e, t)),
                !y.pixelBoxStyles() && Pe.test(a) && Ie.test(t) && (r = s.width, i = s.minWidth, o = s.maxWidth,
        ...
        function Je(e, t, n) {
            ...
            return (!y.boxSizingReliable() && i || !y.reliableTrDimensions() && A(e, "tr") || "auto" === a || !
                ...
                a) || 0) + Qe(e, t, n || (i ? "border" : "content"), o, r, a) + "px"
        }
        ...
        S.extend({
            ...
            css: function(e, t, n, r) {
                ...
                return Xe.test(t) || (t = ze(s)), (a = S.cssHooks[t] || S.cssHooks[s]) && "get" in a &&
                    ...
                    Ge && (i = Ge[t]), "" === n || n ? (o = parseFloat(i), !0 === n || isFinite(o) ?
                        o || 0 : i) : i
            }
            ...
            run: function(e) {
                ...
                return this.options.duration ? this.pos = t = S.easing[this.easing](e, this.options
                    ...
                    .call(this.elem, this.now, this), n && n.set ? n.set(this) : Ke.propHooks._default
                    .set(this), this
            }
        ...
        S.Animation = S.extend(lt, {
                        ...
                        for (r in f && 1 === e.nodeType && (n.overflow = [h.overflow, h.overflowX, h
                            ...
                            .access(e, "fxshow", {
                                ...
                                for (r in g || le([e]), Y.remove(e, "fxshow"), d) S.style(e, r,
                                    d[r])
                            })), u = ut(g ? v[r] : 0, r, p), r in v || (v[r] = u.start, g && (u
                ...
                S.fn[r] = function(e, t, n) {
                    return null == e || "boolean" == typeof e ? i.apply(this, arguments) : this.animate(st(
                        r, !0), e, t, n)
                }
            }), S.each({
                slideDown: st("show"),
        ...
        Mt.href = bt.href, S.extend({
            ...
            ajax: function(e, t) {
                ...
                for (i in (g = S.event && v.global) && 0 == S.active++ && S.event.trigger("ajaxStart"),
                    v.type = v.type.toUpperCase(), v.hasContent = !Lt.test(v.type), f = v.url.replace(
                        jt, ""), v.hasContent ? v.data && v.processData && 0 === (v.contentType || "")
                    .indexOf("application/x-www-form-urlencoded") && (v.data = v.data.replace(Nt,
                    "+")) : (o = v.url.slice(f.length), v.data && (v.processData || "string" == typeof v
                            .data) && (f += (Tt.test(f) ? "&" : "?") + v.data, delete v.data), !1 === v
                        .cache && (f = f.replace(Dt, "$1"), o = (Tt.test(f) ? "&" : "?") + "_=" + wt
                            .guid++ + o), v.url = f + o), v.ifModified && (S.lastModified[f] && T
                        ...
                        ", " + Rt + "; q=0.01" : "") : v.accepts["*"]), v.headers) T.setRequestHeader(i,
                    v.headers[i]);
                ...
                function l(e, t, n, r) {
                    ...
                    h || (h = !0, d && C.clearTimeout(d), c = void 0, p = r || "", T.readyState = 0 <
                        ...
                        n) {
                            ...
                            "json", v.dataTypes) < 0 && (v.converters["text script"] =
                        ...
                        .statusCode(w), w = void 0, g && m.trigger(i ? "ajaxSuccess" : "ajaxError",
                            ...
                            "ajaxComplete", [T, v]), --S.active || S.event.trigger("ajaxStop")))
                }
                return T
            },
        ...
        S.ajaxSetup({
            ...
            var r, i, o, a = !1 !== e.jsonp && (Ut.test(e.url) ? "url" : "string" == typeof e.data && 0 ===
                (e.contentType || "").indexOf("application/x-www-form-urlencoded") && Ut.test(e.data) &&
                "data");
